...
:::{.callout-warning}
**Excepción:** Todos los módulos **r.in.\*** leen los datos celda por celda sin 
...
![a- Máscara activa. b- Máscara desactivada.](../assets/img/mask_applied_vs_mask_removed.png)
...
![Máscara leída al exportar](../assets/img/mask_read_when_exporting.png)
...
![](../assets/img/save_region_from_display.png)
...
<img src="../assets/img/r_mapcalc_gui.png" width="70%">
