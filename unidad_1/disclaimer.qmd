...
-   Se asume que las personas participantes **leyeron los requisitos básicos previo a la inscripción** en el curso, por lo tanto son responsables de las consecuencias en caso de no alcanzarlos.
...
-   Las personas participantes tienen una cuenta de **Gmail** para poder ejecutar las notebooks en Google Colab.
...
-   3 opciones: informe, tutorial o addon
-   Ver la [consigna e instrucciones](../trabajo_final.html)
