...
Las mismas podrán ejecutarse de manera local, en 
[Google Colab](https://colab.research.google.com/) o 
en la plataforma [The Whole Tale](https://wholetale.org/). 
...
El resto del curso se ejecutará **con notebooks en línea** ya sea dentro de la 
plataforma [**Whole Tale**](https://wholetale.org/) o en 
...
necesitaremos reinstalar en cada sesión. Pero... don't worry! Estará todo
en las notebooks.

### Datos necesarios

* Descargar el [archivo comprimido (~ 3.5 Gb)](https://drive.google.com/file/d/1rMzsUMQM6wIL7hhuWDJkhvffq5WgO3wB/view?usp=sharing) 
